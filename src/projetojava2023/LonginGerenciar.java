 ...
 * @author 910640
 */
public class LonginGerenciar extends javax.swing.JFrame {

    /**
     * Creates new form LonginGerenciar
     */
       ...
       JTable tabela = new JTable(modelo);
        ...
        try {
             ...
             ResultSet rs = st.getResultSet();
                ...
                modelo.addRow(new Object[]{id, usuario, email});
                }
    ...
    public LonginGerenciar() {
        setTitle("Gerenciamento de login");
        tabelaCompleta();
        initComponents();
        this.setLocationRelativeTo(null);
    }
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1241, 876));
        setMinimumSize(new java.awt.Dimension(1241, 876));
        getContentPane().setLayout(null);
        ...
        buscar.setBounds(1260, 610, 80, 30);
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        LoginExcluir home = new LoginExcluir();
        home.setVisible(true);
    }//GEN-LAST:event_excluirActionPerformed

    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
        LoginEditar home = new LoginEditar();
        home.setVisible(true);
    }//GEN-LAST:event_editarActionPerformed

    private void cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarActionPerformed
        LoginCadastrar home = new LoginCadastrar();
        home.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LonginGerenciar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LonginGerenciar().setVisible(true);
            }
        });
    }
