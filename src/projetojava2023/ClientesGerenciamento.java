 ...
 * @author 910640
 */
public class ClientesGerenciamento extends javax.swing.JFrame {

    /**
     * Creates new form ClientesGerenciamento
     */
   public void tabelaCompleta() {
       ...
       JTable tabela = new JTable(modelo);
        ...
        try {
          //Registra JDBC driver
             ...
             //pegando dados da tabela
                ...
                modelo.addRow(new Object[]{id, nome, dataNasc, cpf, tel, email, bairro, rua, num,cidade});
                }
        ...
        scrollPane.setBounds(12, 120, 1165, 703);
        c.add(scrollPane);
    ...
    public void resultadobusca(String buscarnome) {
        ...
        try {
          //Registra JDBC driver
             ...
             java.sql.Statement st = conn.createStatement();
             //st.executeQuery("select * from aluno ORDER BY nome asc");
             st.executeQuery("select * from cliente where nome like  '%"+campoBusca+"%'");
             ResultSet rs = st.getResultSet();
             //pegando dados da tabela
                while (rs.next()) {
                String id = rs.getString("id");
    ...
    String p;
    public ClientesGerenciamento(String p) {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1241, 896));
        getContentPane().setLayout(null);
        ...
        campoBusca.setBounds(1290, 450, 140, 30);
        ...
        buscar.setBounds(1280, 510, 80, 30);
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        ClienteExcluir home = new ClienteExcluir();
        home.setVisible(true);
    }//GEN-LAST:event_excluirActionPerformed

    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
       ClienteEditar home = new ClienteEditar();
        home.setVisible(true);
    }//GEN-LAST:event_editarActionPerformed

    private void cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarActionPerformed
        ClienteCadastrar home = new ClienteCadastrar();
        home.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientesGerenciamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientesGerenciamento(null).setVisible(true);
            }
        });
    }
