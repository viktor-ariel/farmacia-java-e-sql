    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        try{
            ...
            while(rs.next()){
                ...
                String message = "Tem certeza que deseja excluir " + rs.getString("usuario")+ " ?";
                String title = "Confirmação";
                int reply = JOptionPane.showConfirmDialog(null, message, title, JOptionPane.YES_NO_OPTION);

                if (reply == JOptionPane.YES_OPTION){
                    java.sql.Statement st2 = conn.createStatement();
                    st2.executeUpdate("DELETE FROM login WHERE id="+this.id.getText()+" ");
                    JOptionPane.showMessageDialog(rootPane, rs.getString("usuario")+" excluido com sucesso!");
                    id.setText(null);
                }
            }
