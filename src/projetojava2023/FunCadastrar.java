 ...
 * @author 910640
 */
public class FunCadastrar extends javax.swing.JFrame {

    /**
     * Creates new form FunCadastrar
     */
    public FunCadastrar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        rua.setBounds(180, 250, 150, 30);
        getContentPane().add(bairro);
        bairro.setBounds(180, 210, 150, 30);
        getContentPane().add(num);
        num.setBounds(180, 290, 150, 30);
        ...
        cidade.setBounds(180, 330, 150, 30);
        getContentPane().add(email);
        email.setBounds(180, 170, 150, 30);

        jLabel1.setText("ID");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(820, 270, 21, 14);
        ...
        jLabel6.setBounds(130, 220, 86, 14);
    ...
    private void cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarActionPerformed
         try{
            ...
            st.executeUpdate("INSERT INTO `funcionario`(`nome`,`dataNasc`,`cpf`,`email`,`bairro`,`rua`,`num`,`cidade`) VALUES ('" 
                    //+ this.id.getText() + ",'" 
                    + this.nome.getText() +"','" 
...
//            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FunCadastrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FunCadastrar().setVisible(true);
            }
        });
    }
